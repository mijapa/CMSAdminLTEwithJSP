...
<%--                    </li>--%>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active"><a href="pages.jsp"><i class="fa fa-link"></i> <span>Pages</span></a></li>
                <li><a href="functions.jsp"><i class="fa fa-link"></i> <span>Functions</span></a></li>
                <li class="treeview">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Functions
                <small>Funkcje użytkownika</small>
            </h1>
            <ol class="breadcrumb">
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2016 <a href="#">MP</a>.</strong> All rights reserved.
    </footer>
